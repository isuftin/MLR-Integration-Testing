...
DOCKER_OUTPUT_DIR="/tests/output/wscfileexporter"
...
docker run --rm \
  ...
  jmeter-base:latest jmeter \
    ...
    -j $DOCKER_OUTPUT_DIR/jmeter-output/jmeter-wscfileexporter.log \
    -l $DOCKER_OUTPUT_DIR/jmeter-output/jmeter-testing-wscfileexporter.jtl \
