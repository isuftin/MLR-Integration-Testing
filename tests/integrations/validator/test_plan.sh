...
DOCKER_OUTPUT_DIR="/tests/output/validator"
...
docker run --rm \
  ...
  jmeter-base:latest jmeter \
    ...
    -j $DOCKER_OUTPUT_DIR/jmeter-output/jmeter-validator.log \
    -l $DOCKER_OUTPUT_DIR/jmeter-output/jmeter-testing-validator.jtl \
